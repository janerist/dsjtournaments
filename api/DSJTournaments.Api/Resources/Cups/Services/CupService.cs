...
namespace DSJTournaments.Api.Resources.Cups.Services
{
    public class CupService
    {
        ...
        public CupService(CupQueries cupQueries, TournamentQueries tournamentQueries, Database database)
        {
        ...
        private async Task ConnectTournaments(int gameVersion, CupDate[] cupDates)
        {
            ...
            var lookup = (await _tournamentQueries
                .TournamentQuery()
                .Where("t.game_version = @GameVersion", new {GameVersion = gameVersion})
                .Where("t.date = ANY(@Dates)", new {Dates = dates})
