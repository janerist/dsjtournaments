...
public class Database
{
    ...
    private static readonly ConcurrentDictionary<Type, List<PropertyInfo>> TypePropertyCache = new();
    private static readonly ConcurrentDictionary<Type, List<PropertyInfo>> KeyPropertyCache = new();

    private static readonly ConcurrentDictionary<string, string> ColumnNameMap = new();
