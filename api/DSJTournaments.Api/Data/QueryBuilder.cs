...
public class QueryBuilder<T>
{
    ...
    private IEnumerable<string> _fromClauses = [];
    private IEnumerable<string> _selectClauses = [];
    private IEnumerable<string> _whereClauses = [];
    private IEnumerable<string> _joinClauses = [];
    private IEnumerable<string> _groupByClauses = [];
    private IEnumerable<string> _orderByClauses = [];
