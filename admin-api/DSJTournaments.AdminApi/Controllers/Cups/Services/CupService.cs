...
using DSJTournaments.AdminApi.Controllers.Cups.RequestModels;
using DSJTournaments.AdminApi.Controllers.Cups.ResponseModels;
using DSJTournaments.Data;
using DSJTournaments.Data.Schema;
using DSJTournaments.Mvc.Exceptions;
using DSJTournaments.Mvc.Responses;

namespace DSJTournaments.AdminApi.Controllers.Cups.Services
{
